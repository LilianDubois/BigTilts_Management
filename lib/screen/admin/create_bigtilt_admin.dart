...
class CreateBigtiltScreen extends StatefulWidget {
  var uid;
  var lenght;
  CreateBigtiltScreen(this.uid, this.lenght);

  @override
  _CreateBigtiltScreenState createState() => _CreateBigtiltScreenState();
}
